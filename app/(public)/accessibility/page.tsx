...
/**
 * A11Y-9: a Hebrew accessibility statement with the name and contact details of
 * the accessibility coordinator — required by the Equal Rights for Persons with
 * Disabilities regulations, not optional.
 *
 * [DECISION NEEDED — open decision #9] The named coordinator and their contact
 * details must come from the product owner before launch. The placeholders
 * below are marked so they cannot ship unnoticed.
 */
const COORDINATOR = {
  ...
  return (
    <div className="shell-narrow py-14 sm:py-20">
      ...
      <section className="mt-8 space-y-3">
        ...
        <p>
          תוכן שנוסף על ידי מנהלי המגרש — למשל תמונות בדף ההנצחה — עשוי במקרים נדירים לחסר תיאור
          חלופי. נשמח לקבל דיווח על כל תקלה כזו ולתקן אותה.
        </p>
      </section>
